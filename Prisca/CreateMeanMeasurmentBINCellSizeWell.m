...
function CreateMeanMeasurmentBINCellSizeWell(strBASIC)
...
%     
    ...
    handles = struct();
    handles.Measurements.Well.(['ModelCellSize_',strFeatureName,strObjectName]) = [];
    handles.Measurements.Well.(['ModelCellSize_',strFeatureName,strObjectName]) = cellMeanIntensity';
    handles.Measurements.Well.(['ModelCellSize_',strFeatureName,strObjectName,'Features']) = plate_feature_vector_names;
    %strOutputFileName = fullfile(strPlatePath,['Measurements_Well_MeanVesiclesIntensity',strFeatureName,strObjectName,'.mat']);
    strOutputFileName = fullfile(strPlatePath,['Measurements_Well_ModelCellSize_PreNuclei',strFeatureName,'.mat']);
