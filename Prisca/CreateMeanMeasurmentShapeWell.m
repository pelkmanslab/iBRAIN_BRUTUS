...
function CreateMeanMeasurmentShapeWell(strBASIC)
...
file_names = {['Measurements_',strObjectName,strFeatureName]};
...
%     
    ...
    handles = struct();
    handles.Measurements.Well.(['Shape_',strFeatureName,strObjectName]) = [];
    handles.Measurements.Well.(['Shape_',strFeatureName,strObjectName]) = cellMeanIntensity';
    handles.Measurements.Well.(['Shape_',strFeatureName,strObjectName,'Features']) = plate_feature_vector_names;
    %strOutputFileName = fullfile(strPlatePath,['Measurements_Well_MeanVesiclesIntensity',strFeatureName,strObjectName,'.mat']);
    strOutputFileName = fullfile(strPlatePath,['Measurements_Well_Shape_',strFeatureName,'.mat']);
