  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: '/img/progressbar/percentImage.png',			// boxImage : image around the progress bar
			barImage	: '/img/progressbar/percentImage_back1.png',	// Image to use in the progressbar. Can be an array of images too.
