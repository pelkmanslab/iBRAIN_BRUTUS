function [totaldiscarded, matdiscarded ] = check_outoffocus_via_granularity_2(strRootPath)
...
%         strRootPath = '\\Nas-biol-imsb-1\share-2-$\Data\Users\Berend\BATCH_RESULTS\Data\Users\VSV_DG\070320_VSV_DG_batch2_CP022-1ab\DATAFUSION\';       
...
%         matImageIntensities = cell2mat(handles.Measurements.Image.Intensity_RescaledGreen');
        matImageObjectCount = cell2mat(handles.Measurements.Image.ObjectCount');     
        matImageGrans = cell2mat(handles.Measurements.Image.(BlueSpectrum )');
