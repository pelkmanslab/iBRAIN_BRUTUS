...
%
%   --------------------------
%   TO DO: consider adding local peaks, eg. via FUN "findpeaks" to unmix
%   overlappping spots or define local maxima. note that IMREGIONALMAX used
%   in original PrimLoG2 works on a fixed connected neigbhourhood and
%   212121 within permitted area-volume would yield 3 spots
%   ----------------------------------
%   Information about module:
%   Created by TS as part of CP3D to detect Objects by filtering, either by
%   wrapping inside a CP3D module or independent scripts outside of CP
