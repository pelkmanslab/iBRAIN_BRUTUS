...
%     '3D LoG, Raj' 3D Laplacian of Gaussian filter, according to Raj et al. 2009
%
...
%   of Gaussian into adjacent z planes. Default for PLANES is 3 (Raj et al.)
%
%   ----------------------------------
%   Information about module:
%   Created by TS as part of CP3D to standardize filters used by scripts
%   and modules (of object detection)
%
