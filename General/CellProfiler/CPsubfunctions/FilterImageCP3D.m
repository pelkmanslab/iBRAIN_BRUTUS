...
% Pad image to reduce border artifact. Note that comment in
% IdentifyPrimLoG2 says "to fix border artifact". However this is not true
% as TS/NB observed when looking at xy distribution of spot centroids.
...
% al. did not use padding. In most scenarios, cells directly at the border
% are discarded
