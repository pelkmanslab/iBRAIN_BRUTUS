...
%choiceVAR10 = GRAS
%choiceVAR10 = HELM
FocusMethod{1} = char(handles.Settings.VariableValues{CurrentModuleNum,10});
...
switch FocusMethod
    case 'BREN'
        ImageRanking = cellfun(@(x) fmeasure(x,'bren',[]));
        ImageRanking = cell2mat(ImageRanking);
        [dummy, ImageRanking] = sort(ImageRanking);
    case 'CURV'
        ImageRanking = cellfun(@(x) fmeasure(x,'curv',[]));
        ImageRanking = cell2mat(ImageRanking);
        [dummy, ImageRanking] = sort(ImageRanking);
    case 'DCTE'
        ImageRanking = cellfun(@(x) fmeasure(x,'dcte',[]));
        ImageRanking = cell2mat(ImageRanking);
        [dummy, ImageRanking] = sort(ImageRanking);
    case 'DCTR'
        ImageRanking = cellfun(@(x) fmeasure(x,'dctr',[]));
        ImageRanking = cell2mat(ImageRanking);
        [dummy, ImageRanking] = sort(ImageRanking);
    case 'GDER'
        ImageRanking = cellfun(@(x) fmeasure(x,'gder',[]));
        ImageRanking = cell2mat(ImageRanking);
        [dummy, ImageRanking] = sort(ImageRanking);
    case 'GLVA'
        ImageRanking = cellfun(@(x) fmeasure(x,'glva',[]));
        ImageRanking = cell2mat(ImageRanking);
        [dummy, ImageRanking] = sort(ImageRanking);
    case 'GLLV'
        ImageRanking = cellfun(@(x) fmeasure(x,'gllv',[]));
        ImageRanking = cell2mat(ImageRanking);
        [dummy, ImageRanking] = sort(ImageRanking);
    case 'GLVN'
        ImageRanking = cellfun(@(x) fmeasure(x,'glvn',[]));
        ImageRanking = cell2mat(ImageRanking);
        [dummy, ImageRanking] = sort(ImageRanking);
    case 'GRAE'
        ImageRanking = cellfun(@(x) fmeasure(x,'grae',[]));
        ImageRanking = cell2mat(ImageRanking);
        [dummy, ImageRanking] = sort(ImageRanking);
    case 'GRAT'
        ImageRanking = cellfun(@(x) fmeasure(x,'grat',[]));
        ImageRanking = cell2mat(ImageRanking);
        [dummy, ImageRanking] = sort(ImageRanking);
    case 'GRAS'
        ImageRanking = cellfun(@(x) fmeasure(x,'gras',[]));
        ImageRanking = cell2mat(ImageRanking);
        [dummy, ImageRanking] = sort(ImageRanking);
    case 'HELM'
        ImageRanking = cellfun(@(x) fmeasure(x,'helm',[]));
        ImageRanking = cell2mat(ImageRanking);
        [dummy, ImageRanking] = sort(ImageRanking);
