function handles = VirusScreen_Auto_07(handles)

warning off all

% Help for the VirusScreen_Auto_07 module:
% Category: Other
%
% SHORT DESCRIPTION:
% VirusScreen_Double_07 Does double gaussian fitting for two measurements, selects
