...
%%% "OrigImage".
OrigImage = CPretrieveimage(handles,ImageName,ModuleName,'DontCheckColor','DontCheckScale');
...
[handles,RescaledImage] = CPrescale2(handles,OrigImage,RescaleOption,MethodSpecificArguments);
