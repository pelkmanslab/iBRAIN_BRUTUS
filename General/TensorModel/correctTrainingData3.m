function correctTrainingData3(strRootPath, settings)
...
[boolTrainingDataFileExists] =  fileattrib(fullfile(strRootPath,'ProbModel_TensorCorrectedData.mat'));
if boolTrainingDataFileExists
    oldTensorCorrectedData = load(fullfile(strRootPath,'ProbModel_TensorCorrectedData.mat'));
