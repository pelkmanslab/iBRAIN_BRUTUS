function RunPreCluster2_VSV_DG(strRootPath)
...
for folderLoop = 1:size(RootPathFolderList,1)
    ...
    if ~strcmpi(RootPathFolderList{folderLoop,1}, strOutputFolder) && ...
        ...
        RunPreCluster2_VSV_DG(strSubfolderPath)
...
%             PreCluster(strCPOutputFile, strInputFolderPath, strOutputFolderPath)            
            PreCluster(strCPOutputFile, strInputFolderPath, strOutputFolderPath, {'_w460.tif','_w530.tif'})
        end
    end
end
