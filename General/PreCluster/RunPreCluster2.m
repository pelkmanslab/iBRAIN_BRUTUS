...
%         strRootPath = '\\Nas-biol-imsb-1\share-2-$\Data\Users\50K_final\RV_KY_2\';        
        strRootPath = '\\nas-biol-imsb-1\share-2-$\Data\Users\50K_final\VV_KY\060606_Vac_Kyo_50K_2_1_3\';                
        
    else
        strRootPath = '/Volumes/share-2-$/Data/Users/50K_final/RV_KY_2/';        
...
% strCPOutputFile = strcat(fileparts(which('RunPreCluster2.m')), filesep, 'PreCluster_FULL_ANALYSIS_50K_PIPEOUT.mat');
 strCPOutputFile = strcat(fileparts(which('RunPreCluster2.m')), filesep, 'PreCluster_FULL_ANALYSIS_50K_20BATCH_PIPEOUT.mat');
...
%             PreCluster(strCPOutputFile, strInputFolderPath, strOutputFolderPath, {'d0.tif','d1.tif'})
            ...
            msgbox(['PreCluster crashed on: ',strInputFolderPath],strInputFolderPath,'warn');
        end
    end
end
