...
find $CURRENTTARGET -maxdepth 2 -type f -name "ProbMod*.mat" -ls -exec rm {} \;
find $CURRENTTARGET -maxdepth 2 -type f -name "mainTensorModel_*.results" -ls -exec rm {} \;
find $CURRENTTARGET -maxdepth 1 -type f -name "ProbModel_*.pdf" -ls -exec rm {} \;
