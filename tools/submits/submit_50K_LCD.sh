...
bsub -W 08:00 -o "${CURRENTTARGET}/BATCH/getLocalCellDensityPerWell_$(date +"%y%m%d%H%M%S").results" "matlab -nodisplay -nojvm << M_PROG
getLocalCellDensityPerWell('$CURRENTTARGET/BATCH/')
M_PROG"
#else
