...
DATAPATH=~/2NAS/Data/Users/Eva/iBRAIN/080208_EMD_SV40_FAKKO_RESC_addbackI
TARGETPATH=~/2NAS/Data/Users/Eva/iBRAIN/080208_EMD_SV40_FAKKO_RESC_addbackI_HardLinks

DATAPATH=~/3NAS/Data/Users/BlockCourse2010
TARGETPATH=~/3NAS/Data/Users/BlockCourse2010_mail
...
FOLDERLIST=`find . -type d -name "BATCH" -printf "%p%%"`

for tiffdir in $FOLDERLIST; do

echo "looking for files in $tiffdir"

FILELIST=`find $tiffdir -type f -name "Measurements_Nuclei_*.mat" -printf "%p%%"`
