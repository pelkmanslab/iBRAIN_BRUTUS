...
for i in $NUMBERS
do
echo "doing optimize_triplicate_scoring_2('$foldername','$i')"
bsub -W 08:00 -oo "$foldername/optimize_triplicate_scoring_2_${i}_$(date +"%y%m%d%H%M%S").results" "matlab -nodisplay -nojvm << M_PROG
optimize_triplicate_scoring_2('$foldername','$i')
M_PROG"
done
