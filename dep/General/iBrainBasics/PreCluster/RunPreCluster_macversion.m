function RunPreCluster(strRootPath)

warning off all;

cd /Applications/MATLAB/PreCluster/

strCPOutputFile = 'PreCluster_FULL_ANALYSIS_50K_PIPEOUT.mat';
%strRootPath = '/Volumes/share-2-$/Data/Users/50K_final/MHV_TDS/';
