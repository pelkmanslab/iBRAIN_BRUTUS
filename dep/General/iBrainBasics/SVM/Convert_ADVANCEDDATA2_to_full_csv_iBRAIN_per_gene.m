...
if nargin==0
    strRootPath = 'Y:\Data\Users\MHV_DG';
...
filename = fullfile(strRootPath,sprintf('ADVANCEDDATA2_%s_per_gene.csv',getlastdir(strRootPath)));
...
cellstrSingleFields = {'GeneData','GeneID','CellTypeOverview.*Stdev'};
