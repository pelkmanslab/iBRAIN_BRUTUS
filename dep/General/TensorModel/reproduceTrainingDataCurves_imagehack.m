...
for i = 2:iDim
    ...
    hold on
    bar(nansum(matRawTotalCells{i}),'FaceColor',[.8 .8 .8],'EdgeColor',[.8 .8 .8])
    box off
    title(strDimFeature{i},'FontSize',6)            
    set(gca,'XLim',matNewXLim,'FontSize',6,'YAxisLocation','right')
    h(1) = gca;

    h(2)=axes();
    boxplot(matRawIIs{i},'color','b')    
%     ylabel('')
%     xlabel('')        
%     errorbar(1:size(matRawIIs{i},2),nanmedian(matRawIIs{i},1),nanstd(matRawIIs{i},1), 'linewidth',1,'color','b','linestyle','none','marker','o','markerfacecolor','b','markersize',6)
    box off
    ylabel('')
    xlabel('')        
...
%     h(3)=axes();
% %     boxplot(matRawIIs{i},'plotstyle','compact')    
% %     ylabel('')
% %     xlabel('')        
%     errorbar(1:size(matModelIIs,2),nanmedian(matModelIIs,1),nanstd(matModelIIs,1), 'linewidth',1,'color','g','linestyle','none','marker','o','markerfacecolor','g','markersize',6)
%     box off
%     ylabel('')
%     xlabel('')            
...
%     set(h(2),'YLim',matNewYLim,'Position',get(h(1),'Position'),'XLim',matNewXLim,'Color','none','XTick',[],'YAxisLocation','left','FontSize',6)    
    set(h(2),'Position',get(h(1),'Position'),'XLim',matNewXLim,'Color','none','XTick',[],'YAxisLocation','left','FontSize',6)    
%    set(h(3),'YLim',matNewYLim,'Position',get(h(1),'Position'),'XLim',matNewXLim,'Color','none','XTick',[],'YTick',[],'YAxisLocation','left','FontSize',6)        
%     set(h(3),'YLim',matNewYLim,'Position',get(h(1),'Position'),'XLim',matNewXLim,'Color','none','XTick',[],'YAxisLocation','left','FontSize',6,'XColor','w','YColor','k','ZColor','w')
