...
for i = 1:length(hFigure)
    ...
    filecounter = 1;
    strPrintName = fullfile(strRootPath,['ProbModel_TcnCurves_',getlastdir(strRootPath),'_',num2str(filecounter),'.pdf']);
    filepresentbool = fileattrib(fullfile(strRootPath,['ProbModel_TcnCurves_',getlastdir(strRootPath),'_',num2str(filecounter),'.pdf']));
