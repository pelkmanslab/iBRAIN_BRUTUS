function [bs,includeds] = testVIF_stepwisefit(TrainingData)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
includeds = nan(size(TrainingData,2),size(TrainingData,2)+1);
...
for iDim = 1:size(TrainingData,2)
    ...
    [b,se,pval,inmodel,stats,nextstep,history] = stepwisefit(xt,yt);
    
    bs(iDim, logical([matAllColumns~=iDim]))=b';
    includeds(iDim, logical([matAllColumns~=iDim]))=inmodel';
%     
%     
%     
%     
