function reproduceTrainingDataCurvesDavesCopy(strRootPath,strFigureTitle)
%%
if nargin == 0
    strRootPath = '/Volumes/share-2-$/Data/Users/David/50Ktest/SV40_MZ/';

   % strRootPath = 'Z:\Data\Users\Berend\BATCH_RESULTS\Data\Users\50K_final\DV_KY2\';
...
%                 X = [X,X.^2,X.^3];
                ...
                X = [ones(size(X,1),1),X];
                Z = double(X) * MasterTensor.Model.Params; %dave's change
...
text(intColumn2,intLineTop+.05,'values','FontSize',10,'FontWeight','bold')        
