...
% seperate neighbouring objects from each other.
%
...
% creates a mask image. If no string is provided, 'Mask' is used as
% default.
%
%
%
% Code written by Thomas Stoeger.
% Code modfied and put into this function by Markus Herrmann.
