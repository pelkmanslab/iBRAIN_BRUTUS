...
%classification
function pca_test_headless_1bin_penetrance(plate_path,config_file,input_path,write_path)
...
num_cells=40;
num_bins=1;%Number of bins the population should be distributed into
...
sample_size1=floor(min(size(treated_population,1)/2,250));%200;%
...
% figure;
% hold on;
%   svmtrain(population(train,[4,7]),groups(train),'Showplot',true,'BoxConstraint',1000000,'Autoscale',false)
