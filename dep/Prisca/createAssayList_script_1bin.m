...
function []=createAssayList_script_1bin(assay)
 plate_paths={   
...
plate1_paths={    '/BIOL/imsb/fs3/bio3/bio3/Data/Users/Prisca/endocytome/090203_MZ_w2Tf_w3EEA1/090203_Mz_Tf_EEA1_CP392-1ad/BATCH',...
 ...
 '/BIOL/imsb/fs3/bio3/bio3/Data/Users/Prisca/endocytome/090403_A431_w2GM1_w3Dextran/090403_A431_Dextran_GM1-CP392-1ag/BATCH', ...
                     ...
                     load_strings={'Measurements_Classification1bin_RFEcp395_TfVes_v2','Measurements_Classification1bin_RFEcp395_EEA1Ves_v2','Measurements_Classification1bin_RFEcp395_ChtxVes_v2','Measurements_Classification1bin_RFEcp395_LampVes_v2','Measurements_Classification1bin_RFEcp395_ChtxVes_v2','Measurements_Classification1bin_RFEcp395_GM130Ves_v2','Measurements_Classification1bin_RFEcp395_EEA1Ves_v2','Measurements_Classification1bin_RFEcp395_TfVes_v2','Measurements_Classification1bin_RFEcp395_DextranVes_v2','Measurements_Classification1bin_RFEcp395_GM1Ves_v2','Measurements_Classification1bin_RFEcp395_ChtxVes_v2','Measurements_Classification1bin_RFEcp395_LDLVes_v2','Measurements_Classification1bin_RFEcp395_EGFVes_v2','Measurements_Classification1bin_RFEcp395_CavVes_v2','Measurements_Classification1bin_RFEcp395_GPIVes_v2','Measurements_Classification1bin_RFEcp395_MacroVes_v2','Measurements_Classification1bin_RFEcp395_EGFVes_v2'};
                     load_strings2={'Measurements_Classification1bin_RFEcp395_TfVes','Measurements_Classification1bin_RFEcp395_EEA1Ves','Measurements_Classification1bin_RFEcp395_ChtxVes','Measurements_Classification1bin_RFEcp395_LampVes','Measurements_Classification1bin_RFEcp395_ChtxVes','Measurements_Classification1bin_RFEcp395_GM130Ves','Measurements_Classification1bin_RFEcp395_EEA1Ves','Measurements_Classification1bin_RFEcp395_TfVes','Measurements_Classification1bin_RFEcp395_DextranVes','Measurements_Classification1bin_RFEcp395_GM1Ves','Measurements_Classification1bin_RFEcp395_ChtxVes','Measurements_Classification1bin_RFEcp395_LDLVes','Measurements_Classification1bin_RFEcp395_EGFVes','Measurements_Classification1bin_RFEcp395_CavVes','Measurements_Classification1bin_RFEcp395_GPIVes','Measurements_Classification1bin_RFEcp395_MacroVes','Measurements_Classification1bin_RFEcp395_EGFVes'};
                     load_strings3={'Measurements_Classification1bin_RFEcp395_TfVes_v3','Measurements_Classification1bin_RFEcp395_EEA1Ves_v3','Measurements_Classification1bin_RFEcp395_ChtxVes_v3','Measurements_Classification1bin_RFEcp395_LampVes_v3','Measurements_Classification1bin_RFEcp395_ChtxVes_v3','Measurements_Classification1bin_RFEcp395_GM130Ves_v3','Measurements_Classification1bin_RFEcp395_EEA1Ves_v3','Measurements_Classification1bin_RFEcp395_TfVes_v3','Measurements_Classification1bin_RFEcp395_DextranVes_v3','Measurements_Classification1bin_RFEcp395_GM1Ves_v3','Measurements_Classification1bin_RFEcp395_ChtxVes_v3','Measurements_Classification1bin_RFEcp395_LDLVes_v3','Measurements_Classification1bin_RFEcp395_EGFVes_v3','Measurements_Classification1bin_RFEcp395_CavVes_v3','Measurements_Classification1bin_RFEcp395_GPIVes_v3','Measurements_Classification1bin_RFEcp395_MacroVes_v3','Measurements_Classification1bin_RFEcp395_EGFVes_v3'};
...
aggregate_distance_c=lin(cat(1,[],pvalue3_c{:,bin}));%nansum(cat(1,[],pvalue3{:,bin}),1);
 ...
 %pvalue1_c{1,bin};%
     ...
     data_control_c=nanmean(aggregate_distance_c(randi([1,length(aggregate_distance_c)],[100,100])),1);
...
data_gene_c=pvalue2_c(gene,1:100);

    pvalue(gene+plate_limit(plate)-1,bin) =max(length(find((data_control(randperm(10000))>(data_gene(randperm(10000))))==1))/10000);
pvalue_dist(gene+plate_limit(plate)-1,bin) =max(length(find((data_control_c(randperm(100))>(data_gene_c(randperm(100))))==1))/100);
    ...
    Gene_id=entrez;
    save(npc(strcat(super_path,'/',load_strings2{assay})),'Gene_list','Gene_id','Normal_vector_matrix_bin_after_bin','margin','Cells_per_bin5','Classification_accuracy','c_crit5','plate_indices','bias','feature_names','Average_distance','pvalue','pvalue_dist');
