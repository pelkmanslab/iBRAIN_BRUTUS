...
function CreateMeanMeasurmentBINWell_CorrRed(strBASIC)
%Load project directory   
% strBASIC = '\\nas-biol-imsb-1\share-3-$\Data\Users\Prisca\090203_Mz_Tf_EEA1_harlink_03_1ad';
...
strObjectName = 'Cells';
strFeatureName = '_CorrGreen';
%file_names = {['Measurements_',strObjectName,'_Intensity',strFeatureName]};
file_names = {['Measurements_BIN_Mean',strFeatureName,'_woCellSize']};
...
%     
    ...
    handles = struct();
    handles.Measurements.Well.(['ModelMeanIntensity_woCellSize_',strFeatureName,strObjectName]) = [];
    handles.Measurements.Well.(['ModelMeanIntensity_woCellSize_',strFeatureName,strObjectName]) = cellMeanIntensity';
    handles.Measurements.Well.(['ModelMeanIntensity_woCellSize_',strFeatureName,strObjectName,'Features']) = plate_feature_vector_names;
    %strOutputFileName = fullfile(strPlatePath,['Measurements_Well_MeanVesiclesIntensity',strFeatureName,strObjectName,'.mat']);
    strOutputFileName = fullfile(strPlatePath,['Measurements_Well_ModelMeanIntensity_woCellSize_',strFeatureName,'.mat']);
