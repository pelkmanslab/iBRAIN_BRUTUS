...
function CreateMeanMeasurmentBINWell(strBASIC)
...
file_names = {['Measurements_BIN_Mean',strFeatureName]};
...
%     
    ...
    handles = struct();
    handles.Measurements.Well.(['ModelMeanIntensity',strFeatureName,strObjectName]) = [];
    handles.Measurements.Well.(['ModelMeanIntensity',strFeatureName,strObjectName]) = cellMeanIntensity';
    handles.Measurements.Well.(['ModelMeanIntensity',strFeatureName,strObjectName,'Features']) = plate_feature_vector_names;
    %strOutputFileName = fullfile(strPlatePath,['Measurements_Well_MeanVesiclesIntensity',strFeatureName,strObjectName,'.mat']);
    strOutputFileName = fullfile(strPlatePath,['Measurements_Well_ModelMeanIntensity',strFeatureName,'.mat']);
